<?php
	...
	if(isset($_SESSION["checkoutPrice"])){
		$totalPrice = $_SESSION["checkoutPrice"];
	}
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>Pay the amount | Ganehs sketch art</title>
...
<body>
	...
	<div class="steps-indicator">
        <div class="floating-steps">
            ...
            <div class="step3 steps active-steps">3</div>
        </div>
        <div class="floating-rect"></div>
    </div>
	<h1>Payment for ordering sketch</h1>
	<pre>
	</pre>
